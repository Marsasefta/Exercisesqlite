...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String MHS_COLUMN_Telp = "telp";
    private HashMap hp;
    ...
    @Override public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(
                "create table mahasiswa " +
                        "(id integer primary key, nama text,alamat" +
                        " text,email text, telp text)"
        );
    }
    ...
    public boolean insertContact (String nama, String alamat, String
            email, String telp)
